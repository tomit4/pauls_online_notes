...
$$ x = \text{ the point along the wire we will cut} $$

$$ 6 - x = \text{ the remaining amount of wire after we cut} $$

$$ L_1 = \text{ the width of the triangle} $$

$$ L_2 = \text{ the length of the triangle} $$

$$ A_{\text{rect}} = \text{ the area of the rectangle} $$

$$ A_{\text{tri}} = \text{ the area of the triangle} $$

$$ A = \text{ the total area of both the rectangle and the triangle} $$

Okay, so firstly let's establish a couple things we already know. One is that
one leg of the rectangle is twice the length of the other:

$$ L_1 = 2L_2 $$

Though not necessary, this means the perimeter of the rectangle can be expressed
as:

$$ x = 2L_1 + 2L_2 = 2(2L_2) + 2L_2 = 6L_2 $$

$$ x = 6L_2 $$

$$ L_2 = \frac{x}{6} $$

We can also express the perimeter of the triangle as:

$$ 6 - x = 3\left(\frac{1}{3}\right)(6 - x) $$

We'll also need the height to calculate $A_{\text{tri}}$, so let's calculate the
height like so:

$$ \sin\left(\frac{\pi}{3}\right) = \frac{\text{opp}}{\text{hyp}} $$

$$ \text{opp} = \frac{1}{3}(6 - x)\sin\left(\frac{\pi}{3}\right) $$

$$ \text{opp} = \frac{1}{3}(6 - x)\left(\frac{\sqrt{3}}{2}\right) $$

$$ \text{opp} = \frac{\sqrt{3}}{6}(6 - x) $$

Let's first calculate the $A_{\text{rect}}$:

$$ A_{\text{rect}} = lw = L_1 \times L_2 = 2L_2 \times L_2 = 2(L_2)^2 = 2\left(\frac{x}{6}\right)^2 $$

And now let's calculate $A_{\text{tri}}$:

$$ A_{\text{tri}} = \frac{1}{2}bh = \frac{1}{2}\left(\frac{6 - x}{3}\right)\left(\frac{\sqrt{3}}{6}\right)(6 - x) = \frac{\sqrt{3}}{12}\left(\frac{(6 - x)^2}{3}\right) $$

Let's simplify these even further:

$$ A_{\text{rect}} = 2\left(\frac{x^2}{36}\right) = \frac{x^2}{18} $$

$$ A_{\text{tri}} = \frac{\sqrt{3}}{36}(6 - x)^2 $$

Thusly our total area can be expressed as:

$$ A(x) = A_{\text{rect}} + A_{\text{tri}} $$

$$ A(x) = \frac{x^2}{18} + \frac{\sqrt{3}}{36}(6 - x)^2 $$

$$ A(x) = \frac{2x^2 + \sqrt{3}(6 - x)^2}{36} $$

Now let's find the first derivative of the area:

$$ A'(x) = \frac{\left(2x^2 + \sqrt{3}(6 - x)^2\right)'(36) - \left(2x^2 + \sqrt{3}(6 - x)^2\right)(36)'}{(36)^2} $$

$$ A'(x) = \frac{\left(2x^2 + \sqrt{3}(6 - x)^2\right)'}{36} $$

$$ A'(x) = \frac{4x + (\sqrt{3})'(6 - x)^2 + (\sqrt{3})\left[(6 - x)^2\right]'}{36} $$

$$ A'(x) = \frac{4x + (\sqrt{3})(2)(6 - x)(6 - x)'}{36} $$

$$ A'(x) = \frac{4x + (\sqrt{3})(2)(6 - x)(-1)}{36} $$

$$ A'(x) = \frac{4x - (\sqrt{3})(2)(6 - x)}{36} $$

$$ A'(x) = \frac{2x - \sqrt{3}(6 - x)}{18} $$

Setting this to $0$ yields critical point(s):

$$ \frac{2x - \sqrt{3}(6 - x)}{18} = 0 $$

$$ x \approx 2.7846 $$

Notice that the range for $x$ must be:

$$ 0 \leq x \leq 6 $$

Thusly let's check the area function for this critical point as well as at the
endpoints and take the minimum.

$$ A(x) = \frac{2x^2 + \sqrt{3}(6 - x)^2}{36} $$

$$ A(0) = \frac{2(0)^2 + \sqrt{3}(6 - (0))^2}{36} \approx 1.7321 $$

$$ A(2.7846) = \frac{2(2.7846)^2 + \sqrt{3}(6 - (2.7846))^2}{36} \approx 0.9282 $$

$$ A(6) = \frac{2(6)^2 + \sqrt{3}(6 - (6))^2}{36} = 2 $$

So, it looks like the minimum area will arise if we take $x = 2.7846$.
...
$$ x = \text{ the length of the first piece of wire cut and bent into a circle} $$

$$ 250 - x = \text{ the length of the second piece of the wire cut and bent into a triangle} $$

$$ C = \text{ the circumference of the circle} $$

$$ r = \text{ the radius of the circle} $$

$$ h = \text{ the height of the triangle} $$

$$ b = \text{ the base of the triangle} $$

$$ A_{\text{circ}} = \text{ the area of the circle} $$

$$ A_{\text{tri}} = \text{ the area of the triangle} $$

$$ A = \text{ the total area of both the triangle and the circle} $$

Let's establish a few things about what we know:

Firstly, let's establish what we know about the circle:

$$ C = x = 2\pi r $$

Let's also establish what we know about the triangle:

Each leg of the triangle will be in length:

$$ b = \frac{1}{3}(250 - x) $$

And we can calculate the height as before:

$$ h = \frac{\sqrt{3}}{6}(250 - x) $$

Let's first calculate $A_{\text{circ}}$:
...
$$ A_{\text{circ}} = \pi \left(\frac{x}{2\pi}\right)^2 $$

$$ A_{\text{circ}} = \pi \left(\frac{x^2}{4\pi^2}\right) $$

$$ A_{\text{circ}} = \frac{x^2}{4\pi} $$
...
$$ A_{\text{tri}} = \frac{1}{2}\left(\frac{1}{3}(250 - x)\right)\left(\frac{\sqrt{3}}{6}(250 - x)\right) $$

$$ A_{\text{tri}} = \frac{\sqrt{3}}{36}(250 - x)^2 $$

And so our total area can be expressed as:

$$ A(x) = A_{\text{circ}} + A_{\text{tri}} $$

$$ A(x) = \frac{x^2}{4\pi} + \frac{\sqrt{3}}{36}(250 - x)^2 $$

Find first derivative:

$$ A'(x) = \frac{(x^2)'(4\pi) - (x^2)(4\pi)'}{(4\pi)^2} + \frac{(\sqrt{3}(250 - x)^2)'(36) - (\sqrt{3}(250 - x)^2)(36)'}{(36)^2} $$

$$ A'(x) = \frac{(2x)(4\pi)}{(4\pi)^2} + \frac{\left[(\sqrt{3})'(250 - x)^2 + (\sqrt{3})\left[(250 - x)^2\right]'\right](36)}{(36)^2} $$

$$ A'(x) = \frac{x}{2\pi} + \frac{\sqrt{3}(2)(250 - x)(250 - x)'}{36} $$

$$ A'(x) = \frac{x}{2\pi} + \frac{\sqrt{3}(2)(250 - x)(-1)}{36} $$

$$ A'(x) = \frac{x}{2\pi} - \frac{\sqrt{3}(250 - x)}{18} $$

And if set to $0$ we get:
...
Check critical point and endpoints, take minimum:

$$ A(x) = \frac{x^2}{4\pi} + \frac{\sqrt{3}}{36}(250 - x)^2 $$

$$ A(0) = \frac{(0)^2}{4\pi} + \frac{\sqrt{3}}{36}(250 - (0))^2 \approx 3007.0327 $$

$$ A(94.1979) = \frac{(94.1979)^2}{4\pi} + \frac{\sqrt{3}}{36}(250 - (94.1979))^2 \approx 1874.0079 $$

$$ A(250) = \frac{(250)^2}{4\pi} + \frac{\sqrt{3}}{36}(250 - (250))^2 \approx 4973.5920 $$

So it looks like if we don't cut the wire and just bend the entire wire into a
circle, we'll get the maximize amount of area.
...
This is the same question as 11, except we are asked to find the **minimum**.
Let's take our final evaluations from the previous question and pick the minimum
area:
...
So it looks like if we cut the wire at $x = 94.1979 \text{ cm}$, we will
minimize the area enclosed by both the resulting circle and triangle.
...
$$ x = \text{ the length of the first section of wire that is used for the circle} $$

$$ 4 - x = \text{ the length of the second section of wire that is used for the rectangle} $$

$$ L_1 = \text{ the width of the rectangle} $$

$$ L_2 = \text{ the length of the rectangle} $$
...
$$ A = \text{ the total area of both the rectangle and the circle} $$

Let's establish what we know. Starting with the circle:

$$ C = x = 2\pi r $$

Let's express this in terms of $r$:

$$ r = \frac{x}{2\pi} $$

Let's now address the rectangle, recall that one leg of the rectangle is 3 times
longer than the other:

$$ L_1 = 3L_2 $$

We know that $4 - x$ is the perimeter of the rectangle, so:
...
Let's express this as $L_2$:

$$ L_2 = \frac{4 - x}{8} $$

So now let's calculate the area of both the circle and the rectangle.

Starting with $A_{\text{circ}}$:
...
Now let's calculate $A_{\text{rect}}$:

$$ A_{\text{rect}} = lw = L_1 \times L_2 $$

$$ A_{\text{rect}} = 3L_2 \times L_2 $$

$$ A_{\text{rect}} = 3(L_2)^2 $$

$$ A_{\text{rect}} = 3\left(\frac{4 - x}{8}\right)^2 $$

$$ A_{\text{rect}} = \frac{3(4 - x)^2}{64} $$

So our total area can be expressed as:

$$ A = A_{\text{circ}} + A_{\text{rect}} $$

$$ A(x) = \frac{x^2}{4\pi} + \frac{3(4 - x)^2}{64} $$

Find the first derivative:

$$ A'(x) = \frac{(x^2)'(4\pi) - (x^2)(4\pi)'}{(4\pi)^2} + \frac{\left[3(4 - x)^2\right]'(64) - \left[3(4 - x)^2\right](64)'}{(64)^2} $$

$$ A'(x) = \frac{x}{2\pi} + \frac{(3)'\left[(4 - x)^2\right] + (3)\left[(4 - x)^2\right]'}{64} $$

$$ A'(x) = \frac{x}{2\pi} + \frac{3(2)(4 - x)(4 - x)'}{64} $$

$$ A'(x) = \frac{x}{2\pi} + \frac{3(4 - x)(-1)}{32} $$

$$ A'(x) = \frac{x}{2\pi} - \frac{3(4 - x)}{32} $$

$$ A'(x) = \frac{x}{2\pi} - \frac{12 - 3x}{32} $$

And if we set to $0$ we get:

$$ x \approx 1.4828 $$

Note that our range for $x$ is:

$$ 0 \leq x \leq 4 $$

So let's plug in this critical point as well as the endpoints into our Area
function and take the maximum as our answer:

$$ A(x) = \frac{x^2}{4\pi} + \frac{3(4 - x)^2}{64} $$

$$ A(0) = \frac{(0)^2}{4\pi} + \frac{3(4 - (0))^2}{64} = \frac{3}{4} = 0.75 $$

$$ A(1.4828) = \frac{(1.4828)^2}{4\pi} + \frac{3(4 - (1.4828))^2}{64} \approx 0.4720 $$

$$ A(4) = \frac{(4)^2}{4\pi} + \frac{3(4 - (4))^2}{64} \approx 1.2732 $$

And so it looks like if we don't cut the wire and instead just bend the entire
wire into a circle, we will maximize the area.
...
Let $(a, 0)$ be the point on the $x$-axis that marks one leg of the triangle,
and also let $(0, b)$ be the point on the $y$-axis that marks the other leg of
the triangle. Note that we are given that a point $(-4, 1)$ that lies on the
hypotenuse of this triangle. By observing this, we know that $a < -4$ and that
$b > 1$.
...
If we use the point given, $(-4, 1)$, and use the $x$-axis point $(a, 0)$, this
becomes:
...
$$ 0 = \left(\frac{1}{-4 - a}\right)a + b $$

Note that if we plugged in the $y$ -intercept, $(0, b)$, we'd get:

$$ b = \left(\frac{1}{-4 - 0}\right)0 + b $$
...
$$ -b = \left(\frac{1}{-4 - a}\right)a $$

$$ -b = \left(\frac{1}{a - 4}\right)a $$
...
$$ A(a) = \frac{1}{2}a\left(\frac{a}{a + 4}\right) $$
...
$$ A'(a) = \frac{(a^2)'(2a + 8) - (a^2)(2a + 8)'}{(2a + 8)^2} $$

$$ A'(a) = \frac{2a(2a + 8) - a^2(2)}{(2a + 8)^2} $$

$$ A'(a) = \frac{4a^2 + 16a - 2a^2}{(2a + 8)^2} $$

$$ A'(a) = \frac{2a^2 + 16a}{(2a + 8)^2} $$

$$ A'(a) = \frac{2a(a + 8)}{(2a + 8)^2} $$
...
Thinking on it, we can't use $a = 0$, as that will negate our triangle. We also
can't use $a = -4$ for a couple of reasons. Firstly it negates our given point
$(-4, 1)$, and also if we plug it into the Area formula, it causes our area to
be $0$.

This leaves only $a = -8$ as a critical point that could lead to an absolute
minimum. We can now plug in our critical point of $a = -8$ into both the slope
and line formulas to find our line:
...
Let $(a, 0)$ be the point on the $x$-axis that marks one leg of the triangle,
and also let $(0, b)$ be the point on the $y$-axis that marks the other leg of
the triangle. Note that we are given that a point $(3, 3)$ that lies on the
hypotenuse of this triangle. By observing this, we know that $a > 3$ and that
$b > 3$.
...
If we use the point given, $(3, 3)$, and use the $x$-axis point $(a, 0)$, this
becomes:
...
$$ y = \left(\frac{3}{3 - a}\right)x + b $$

Now plug in $(a, 0)$:

$$ 0 = \left(\frac{3}{3 - a}\right)a + b $$

Note that if we plugged in the $y$ -intercept, $(0, b)$, we'd get:

$$ b = \left(\frac{3}{3 - a}\right)0 + b $$
...
$$ A(a) = \frac{1}{2}a\left(\frac{3a}{a - 3}\right) $$
...
$$ A'(a) = \frac{\left(3a^2\right)'(2a - 6) - \left(3a^2\right)(2a - 6)'}{(2a - 6)^2} $$

$$ A'(a) = \frac{6a(2a - 6) - \left(3a^2\right)(2)}{(2a - 6)^2} $$

$$ A'(a) = \frac{12a^2 - 36a - 6a^2}{(2a - 6)^2} $$

$$ A'(a) = \frac{6a^2 - 36a}{(2a - 6)^2} $$

$$ A'(a) = \frac{6a(a - 6)}{(2a - 6)^2} $$
...
We can omit $a = 0$ and $a = 3$ as they both will collapse are triangle. So
$a = 6$ is the only critical point. Let's plug it into our slope and line
formulas:
...
$$ A = \text{ the point where the pipe meets the leftmost wall in the wider (14ft) hallway} $$

$$ C = \text{ the point where the pipe meets the topmost wall in the narrower hallway (6ft)} $$

$$ B = \text{ the point where the pipe meets the innermost corner of the two hallways} $$

$$ L_1 = \text{ the length of the pipe in the narrower hallway (6ft)} $$

$$ L_2 = \text{ the length of the pipe in the wider hallway (14ft)} $$

$$ L = \text{ the total length of the pipe} $$

$$ \theta = \text{ the angle of the pipe to the outermost wall in the wider hallway, as well the angle created from the corner to the wall at which it creates a } 90\degree \text{ angle} $$

Right off the bat, let's just establish the basic fact that:

$$ L = L_2 + L_1 $$

Now, we know from reading **Example 5** of the notes that as $\theta \to 0$, so
does $L \to \infty$. The same occurs as $\theta \to \dfrac{\pi}{2}$, so too does
$L \to \infty$. This shows us the range for $\theta$:

$$ 0 < \theta < \frac{\pi}{2} $$

Basic right angle trigonometry shows us that both $L_1$ and $L_2$ can be defined
in terms of $\theta$ by trigonometric functions. Paul glosses over the
specifics, but here let's elaborate a bit for the purposes of understanding.
Recall that:

$$ \cos\theta = \frac{\text{adj}}{\text{hyp}} $$

If we look at our diagram we'll notice that $L_1$ is the hypotenuse of a smaller
triangle created from the corner $B$ to the topmost wall of the narrower
hallway. We also know that _adjacent_ to $L_1$ must be the width of the hallway,
$6 \text{ ft}$. If we therefore fill in our function for cosine we get:

$$ \cos\theta = \frac{6}{L_1} $$

We could solve for $\theta$ here, but recall that $\theta$ is also constrained
by the width of the wider hallway (the one that is $14 \text{ ft}$ wide).

Let's establish that as well. If we look at the triangle created from $AB$, this
creates a hypotenuse of $L_2$, but this time we have the known width of $14$
_opposite_ $\theta$, this means we must use a different trigonometric function
here. Recall that:

$$ \sin\theta = \frac{\text{opp}}{\text{hyp}} $$

And knowing this , we can extrapolate the expression for $\theta$ constrained by
the width of this hallway as:

$$ \sin\theta = \frac{14}{L_2} $$

Finally we arrive at something that we can plug into our total length summation
that we can then further evaluate for $\theta$.
...
We'll need to solve for $L_1$ and $L_2$ here to get where we need to go though,
so let's do that. In order to do that though, we'll need reciprocal
trigonometric functions. This is simple enough if you recall that:
...
$$ \csc\theta = \frac{L_2}{14} $$

$$ 14\csc\theta = L_2 $$

Though we could have left them in their cosine/sine forms, this is a bit more
readable. Let's now set up for $L$:

$$ L = L_2 + L_1 $$

$$ L = 6\sec\theta + 14\csc\theta $$

We're looking for the minimum $L$ can be here. Solving for $\theta$ will allow
us to determine that, but in order to do that, we'll need to use the first
derivative of the total length. Let's do that. In order to accomplish this,
you'll have to recall your
[**Derivatives Of Trig Functions**](https://tutorial.math.lamar.edu/Classes/CalcI/DiffTrigFcns.aspx#MathJax-Element-54-Frame).

Using this, we can differentiate $L$:

$$ L' = 6\sec\theta\tan\theta - 14\csc\theta\cot\theta $$

Now let's set to $0$ and find the critical point:

$$ 6\sec\theta\tan\theta - 14\csc\theta\cot\theta = 0 $$

$$ 6\sec\theta\tan\theta = 14\csc\theta\cot\theta $$

$$ \sec\theta\tan\theta = \frac{14\csc\theta\cot\theta}{6} $$

$$ \frac{\sec\theta\tan\theta}{\csc\theta\cot\theta} = \frac{14}{6} $$

$$ \frac{\sec\theta\tan^2\theta}{\csc\theta} = \frac{14}{6} $$

$$ \frac{\sin\theta\tan^2\theta}{\cos\theta} = \frac{14}{6} $$

$$ \tan^3\theta = \frac{14}{6} $$

$$ \tan^3\theta = \frac{7}{3} $$

We simplified down to this form because most calculators cannot evaluate the
inverse reciprocal trigonomtric functions (and working with just tangent is
obviously easier). From here we can solve for $\theta$:

$$ \tan^3\theta = \frac{7}{3} $$

$$ \tan\theta = \sqrt[3]{\frac{7}{3}} $$

$$ \theta = \tan^{-1}\left(\sqrt[3]{\frac{7}{3}}\right) $$

$$ \theta \approx 0.9248 $$

This falls within our establised range of $0 < \theta < \dfrac{\pi}{2}$, so all
is well and good. Now just plug in $\theta$ to our Length formula from before,
and this is our longest length for the pipe that can be carried around the turn
in the hallway.

$$ L = 6\sec\theta + 14\csc\theta $$

$$ L \approx 6\sec(0.9248) + 14\csc(0.9248) $$

$$ \boxed{L \approx 27.4997 \text{ ft}} $$
...
We'll work this one a bit faster since we know what's up from problem 16.

Variables:

$$ A = \text{ the point where the pipe meets the leftmost wall in the narrower (9ft) hallway} $$

$$ C = \text{ the point where the pipe meets the topmost wall in the wider hallway (25ft)} $$

$$ B = \text{ the point where the pipe meets the innermost corner of the two hallways} $$

$$ L_1 = \text{ the length of the pipe in the narrower hallway (9ft)} $$

$$ L_2 = \text{ the length of the pipe in the wider hallway (25ft)} $$
...
Establish constraints of widths to $\theta$ as an expression of $L(\theta)$:

$$ \cos\theta = \frac{25}{L_2} $$
...
$$ L = 25\sec\theta + 9\csc\theta $$

Find first derivative.

$$ L' = 25\sec\theta\tan\theta - 9\csc\theta\cot\theta $$

Set to $0$:

$$ 25\sec\theta\tan\theta - 9\csc\theta\cot\theta = 0 $$

$$ 25\sec\theta\tan\theta = 9\csc\theta\cot\theta $$

$$ \sec\theta\tan\theta = \frac{9\csc\theta\cot\theta}{25} $$

$$ \frac{\sec\theta\tan\theta}{\csc\theta\cot\theta} = \frac{9}{25} $$

$$ \frac{\sec\theta\tan^2\theta}{\csc\theta} = \frac{9}{25} $$

$$ \frac{\sin\theta\tan^2\theta}{\cos\theta} = \frac{9}{25} $$

$$ \tan^3\theta = \frac{9}{25} $$

$$ \tan\theta = \sqrt[3]{\frac{9}{25}} $$

$$ \theta = \tan^{-1}\left(\sqrt[3]{\frac{9}{25}}\right) $$
...
$$ L \approx 25\sec(0.6183) + 9\csc(0.6183) $$

$$ \boxed{L \approx 46.2065 \text{ ft}} $$
...
$$ L_1 = \text{ the length of the wire from the top of leftmost pole (15 m tall) to the stake} $$

$$ L_2 = \text{ the length of the wire from the stake to the top of the rightmost pole (10 m tall)} $$

$$ L = L_1 + L_2 = \text{ the total length of the wire} $$

$$ x = \text{ the distance from the base of the leftmost pole (15 m tall) to the stake along the ground} $$

$$ 40 - x = \text{ the distance from the stake along the ground to the base of the rightmost pole (10 m tall)} $$

Filling this in, we can see we actually have all three sides of two right angle
triangles, which means we can use the pythagorean theorem to express $x$. What
we're looking for is a value for $x$ that will minimize the total length of the
wire $L$, so we'll need to first establish a relationship between the two.

$$ x^2 + 15^2 = (L_1)^2 $$

$$ (40 - x)^2 + 10^2 = (L_2)^2 $$

Solving for $L_1$ and $L_2$ here yields:

$$ L_1 = \sqrt{x^2 + 15^2} $$

$$ L_2 = \sqrt{(40 - x)^2 + 10^2} $$

We omit the $\pm$ here because we're dealing in real world lengths. So, let's
establish the total $L$ as $L(x)$:

$$ L = L_1 + L_2 $$

$$ L(x) = \sqrt{x^2 + 15^2} + \sqrt{(40 - x)^2 + 10^2} $$

$$ L(x) = \sqrt{x^2 + 15^2} + \sqrt{x^2 - 80x + 1700} $$

Let's now find the first derivative of $L(x)$:

$$ L(x) = \left(x^2 + 15^2\right)^{\frac{1}{2}} + \left(x^2 - 80x + 1700\right)^{\frac{1}{2}} $$

$$ L'(x) = \frac{1}{2}\left(x^2 + 15^2\right)^{-\frac{1}{2}}\left(x^2 + 15^2\right)' + \frac{1}{2}\left(x^2 - 80x + 1700\right)^{-\frac{1}{2}}\left(x^2 - 80x + 1700\right)' $$

$$ L'(x) = x\left(x^2 + 15^2\right)^{-\frac{1}{2}} + (x - 40)\left(x^2 - 80x + 1700\right)^{-\frac{1}{2}} $$

$$ L'(x) = \frac{x}{\sqrt{x^2 + 15^2}} + \frac{x - 40}{\sqrt{x^2 - 80x + 1700}} $$

Let's set this to $0$ and find some critical point(s):

$$ \frac{x}{\sqrt{x^2 + 15^2}} + \frac{x - 40}{\sqrt{x^2 - 80x + 1700}} = 0 $$

$$ \frac{x}{\sqrt{x^2 + 15^2}} = -\frac{x - 40}{\sqrt{x^2 - 80x + 1700}} $$

$$ x\sqrt{x^2 - 80x + 1700} = -(x - 40)\sqrt{x^2 + 15^2} $$

We'll need to square both sides (be careful, doing this introduces potential
solutions that are not critical points due to the potential $\pm$ results of
squaring for a solution).

$$ x^2\left(x^2 - 80x + 1700\right) = (-1)^2(x - 40)^2\left(x^2 + 15^2\right) $$

$$ x^4 - 80x^3 + 1700x^2 = x^4 - 80x^3 + 1825x^2 - 18000x + 360000 $$

$$ 1700x^2 = 1825x^2 - 18000x + 360000 $$

$$ 125x^2 - 18000x + 360000 = 0 $$

$$ x = \frac{-(-18000) \pm \sqrt{(-18000)^2 - 4(125)(360000)}}{2(125)} $$

$$ x = \frac{18000 \pm 12000}{250} $$

$$ x = 72 \pm 48 $$

$$ x = 24 \text{, } x = 120 $$

Note however, that our range for $x$ _is_ limited! If we think on it $x$ can
only be:

$$ 0 \leq x \leq 40 $$

Even if both of these were within range, we'd want to test them by plugging them
into our first derivative function to make sure they were indeed critical points
(as we noted earlier, squaring in order to solve for $x$ introduced a potential
"false" solution).

Plugging in $24$ into our first derivative function (using calculator) yields
$0$, so is indeed a critical point.

$$ L'(24) = 0 $$

Now we can take the endpoints of our range and this critical point, plug it into
our function for $L(x)$ and take the minimum output as our answer.

$$ L(x) = \sqrt{x^2 + 15^2} + \sqrt{x^2 - 80x + 1700} $$

$$ L(0) = \sqrt{(0)^2 + 15^2} + \sqrt{(0)^2 - 80(0) + 1700} \approx 56.2311 $$

$$ L(24) = \sqrt{(24)^2 + 15^2} + \sqrt{(24)^2 - 80(24) + 1700} \approx 47.1699 $$

$$ L(40) = \sqrt{(40)^2 + 15^2} + \sqrt{(40)^2 - 80(40) + 1700} \approx 52.7200 $$

So it looks like if we place the stake $24 \text{ m}$ from the leftmost pole, we
will use the least amount of wire.
...
This is similar to 18, so let's go a bit faster here.

Variables:

$$ L_1 = \text{ the length of the wire from the top of leftmost pole (2 ft tall) to the stake} $$

$$ L_2 = \text{ the length of the wire from the stake to the top of the rightmost pole (5 ft tall)} $$

$$ L = L_1 + L_2 = \text{ the total length of the wire} $$

$$ x = \text{ the distance from the base of the leftmost pole (2 ft tall) to the stake along the ground} $$

$$ 3 - x = \text{ the distance from the stake along the ground to the base of the rightmost pole (5 ft tall)} $$

Again, pythagorean theorem can be used here:
...
$$ L(x) = \sqrt{x^2 + 4} + \sqrt{x^2 - 6x + 34} $$

Find the first derivative:

$$ L(x) = \left(x^2 + 4\right)^{\frac{1}{2}} + \left(x^2 - 6x + 34\right)^{\frac{1}{2}} $$

$$ L'(x) = \frac{1}{2}\left(x^2 + 4\right)^{-\frac{1}{2}}\left(x^2 + 4\right)' + \frac{1}{2}\left(x^2 - 6x + 34\right)^{-\frac{1}{2}}\left(x^2 - 6x + 34\right)' $$

$$ L'(x) = \frac{1}{2}\left(x^2 + 4\right)^{-\frac{1}{2}}(2x) + \frac{1}{2}\left(x^2 - 6x + 34\right)^{-\frac{1}{2}}(2x - 6) $$

$$ L'(x) = \frac{x}{\sqrt{x^2 + 4}} + \frac{x - 3}{\sqrt{x^2 - 6x + 34}} $$

Set to $0$ and find critical point(s):

$$ \frac{x}{\sqrt{x^2 + 4}} + \frac{x - 3}{\sqrt{x^2 - 6x + 34}} = 0 $$

$$ \frac{x}{\sqrt{x^2 + 4}} = -\frac{x - 3}{\sqrt{x^2 - 6x + 34}} $$

$$ x\sqrt{x^2 - 6x + 34} = -(x - 3)\sqrt{x^2 + 4} $$

Square both sides (again, be careful, can introduce false solutions):

$$ x^2\left(x^2 - 6x + 34\right) = (-1)^2(x - 3)^2\left(x^2 + 4\right) $$

$$ x^4 - 6x^3 + 34x^2 = x^4 - 6x^3 + 13x^2 - 24x + 36 $$

$$ 34x^2 = 13x^2 - 24x + 36 $$

$$ 21x^2 + 24x - 36 = 0 $$

$$ x = \frac{-(24) \pm \sqrt{(24)^2 - 4(21)(-36)}}{2(21)} $$

$$ x = \frac{-24 \pm 60}{42} $$

$$ x = -2 \text{, } x = \frac{6}{7} $$

Recall that our range is $0 \leq x \leq 3$, and a length of $-2$ makes no sense,
so we can omit it. And not only does $x = \dfrac{6}{7}$ fall within the range,
but it also evaluates to $0$ when plugged into our first derivative function
(using a calculator):

$$ L'\left(\frac{6}{7}\right) = 0 $$

Let's plug in our endopoints of our range and our critical point into our length
function, $L(x)$, and take the minimum output as our answer.

$$ L(x) = \sqrt{x^2 + 4} + \sqrt{x^2 - 6x + 34} $$

$$ L(0) = \sqrt{(0)^2 + 4} + \sqrt{(0)^2 - 6(0) + 34} \approx 7.8310  $$

$$ L\left(\frac{6}{7}\right) = \sqrt{\left(\frac{6}{7}\right)^2 + 4} + \sqrt{\left(\frac{6}{7}\right)^2 - 6\left(\frac{6}{7}\right) + 34} \approx 7.6160 $$

$$ L(3) = \sqrt{(3)^2 + 4} + \sqrt{(3)^2 - 6(3) + 34} \approx 8.6056 $$

So it looks like if place our stake at $x = \dfrac{6}{7} \text{ ft}$ from the
leftmost pole, we will use the minimum amount of wire.
...
$$ \theta = \text{ the angle formed by the two wires at the stake} $$

$$ \delta = \text{ the angle formed by the stake and the top of the leftmost pole (15 m tall) relative to the ground} $$

$$ \varphi = \text{ the angle formed by the stake and the top of the rightmost pole (10 m tall) relative to the ground} $$

$$ x = \text{ the distance on the ground from the base of the leftmost pole (15 m tall) to the stake} $$

$$ 40 - x = \text{ the distance on the ground from the stake from the base of the rightmost pole (10 m tall)} $$

Unlike 18 and 19, instead of being asked to give the minimum amount of wire
(note we could still solve that here given the info provided in the problem
statement), we're being asked to give the placement of the stake along the
ground, $x$, that will create the maximum angle made by the wire, $\theta$.

One of the things that we know are that:

$$ \delta + \theta + \varphi = 180 = \pi $$

These angles with the heights of the poles and the bases in terms of $x$ give us
enough information to establish some relationships between these three angles
and $x$. This is done through trigonometric functions. Recall the basic
definition of the trigonmetric function, tangent is:

$$ \tan\alpha = \frac{\text{opp}}{\text{adj}} $$

Using this information, we can establish trigonometric relationships between
$\delta$ and $\varphi$ in terms of $x$:

$$ \tan\delta = \frac{15}{x} $$

$$ \tan\varphi  = \frac{10}{40 - x}$$

And then we can take the inverse trigonometric functions to find a definition
for each of these angles:

$$ \delta = \tan^{-1}\left(\frac{15}{x}\right) $$

$$ \varphi = \tan^{-1}\left(\frac{10}{40 - x}\right) $$

And again, recall that:

$$ \delta + \theta + \varphi = \pi $$

So let's solve for $\theta$ (the angle we want to solve for and maximize) and
then plug in for the two angles we've found (in terms of $x$):

$$ \theta = \pi - \delta - \varphi $$

$$ \theta(x) = \pi - \tan^{-1}\left(\frac{15}{x}\right) - \tan^{-1}\left(\frac{10}{40 - x}\right) $$

Note the use of $\pi$ as inverse tangents return in radians, not degrees.

We'll now need to find the first derivative of $\theta(x)$. If you need to,
please review how to
[**differentiate inverse tangents**](https://tutorial.math.lamar.edu/Classes/CalcI/DiffInvTrigFcns.aspx).

Specifically we'll need this differentiation of inverse tangent formula:

$$ \frac{d}{dx}\left(\tan^{-1}x\right) = \frac{1}{1 + x^2} $$

$$ \theta'(x) = -\frac{1}{1 + \left(\dfrac{15}{x}\right)^2}\left(\frac{15}{x}\right)' - \frac{1}{1 + \left(\dfrac{10}{40 - x}\right)^2}\left(\frac{10}{40 - x}\right)' $$

$$ \theta'(x) = -\frac{1}{1 + \left(\dfrac{15}{x}\right)^2}\left(\frac{(15)'(x) - (15)(x)'}{(x)^2}\right) - \frac{1}{1 + \left(\dfrac{10}{40 - x}\right)^2}\left(\frac{(10)'(40 - x) - (10)(40 - x)'}{(40 - x)^2}\right) $$

$$ \theta'(x) = -\frac{1}{1 + \left(\dfrac{15}{x}\right)^2}\left(\frac{-15}{x^2}\right) - \frac{1}{1 + \left(\dfrac{10}{40 - x}\right)^2}\left(\frac{-(10)(-1)}{(40 - x)^2}\right) $$

$$ \theta'(x) = -\frac{1}{1 + \left(\dfrac{15}{x}\right)^2}\left(-\frac{15}{x^2}\right) - \frac{1}{1 + \left(\dfrac{10}{40 - x}\right)^2}\left(\frac{10}{(40 - x)^2}\right) $$

$$ \theta'(x) = \frac{15}{x^2\left[1 + \left(\dfrac{15}{x}\right)^2\right]} - \frac{10}{(40 - x)^2\left[1 + \left(\dfrac{10}{40 - x}\right)^2\right]} $$

$$ \theta'(x) = \frac{15}{x^2 + 225} - \frac{10}{x^2 - 80x + 1700} $$

Setting to $0$ and find the critical points now:

$$ \frac{15}{x^2 + 225} - \frac{10}{x^2 - 80x + 1700} = 0 $$

$$ \frac{15x}{x^2 + 225} = \frac{10}{x^2 - 80x + 1700} $$

$$ 15\left(x^2 - 80x + 1700\right) = 10\left(x^2 + 225\right) $$

$$ 15x^2 - 1200x + 25500 = 10x^2 + 2250 $$

$$ 5x^2 - 1200x + 23250 = 0 $$

$$ x^2 - 240 x + 4650 = 0 $$

$$ x = \frac{-(-240) \pm \sqrt{(-240)^2 - 4(1)(4650)}}{2(1)} $$

$$ x = \frac{240 \pm 10\sqrt{390}}{2} $$

$$ x = 120 \pm 5\sqrt{390} $$

$$ x \approx 21.2579 \text{, } x \approx 218.7421 $$

Recall though that our range for $x$ is:

$$ 0 \leq x \leq 40 $$

So only the lower value is a critical point we can evaluate for this problem.

We can now use the
[**First Derivative Test**](https://tutorial.math.lamar.edu/Classes/CalcI/Optimization.aspx#MathJax-Element-71-Frame)
to determine if ihndeed this value of $x$ yields the maximum value for $\theta$.

We only need to evaluate if $\theta'(x) > 0$ for all $x < 21.2579$ and also that
if $\theta'(x) < 0$ for all $x > 21.2579$. We can take two test points just
below and just above $21.2579$ and put it into $\theta'(x)$ to find out:

$$ \theta'(x) = \frac{15}{x^2 + 225} - \frac{10}{x^2 - 80x + 1700} $$

$$ \theta'(21) = \frac{15}{(21)^2 + 225} - \frac{10}{(21)^2 - 80(21) + 1700} \approx 0.00083 $$

$$ \theta'(22) = \frac{15}{(22)^2 + 225} - \frac{10}{(22)^2 - 80(22) + 1700} \approx -0.0024 $$

We have proven the above assertion, and thusly, by the First Derivative Test, we
have an _absolute maximum_ at $x \approx 21.2579$, and placing the stake at
$x \approx 21.2579 \text{ m}$ will yield the maximum angle for the angle formed
by the two pieces of wire, $\theta$.
...
This is similar to 20, so we'll move a bit quicker here.

Variables:

$$ \theta = \text{ the angle formed by the two wires at the stake} $$

$$ \delta = \text{ the angle formed by the stake and the top of the leftmost pole (34 in tall) relative to the ground} $$

$$ \varphi = \text{ the angle formed by the stake and the top of the rightmost pole (17 in tall) relative to the ground} $$

$$ x = \text{ the distance on the ground from the base of the leftmost pole (34 in tall) to the stake} $$

$$ 36 - x = \text{ the distance on the ground from the stake from the base of the rightmost pole (17 in tall)} $$

Let's get straight into it. As before, note that:

$$ \delta + \theta + \varphi = \pi $$

So therefore we can use tangent to find an expression of $\delta$ and $\varphi$
in terms of $x$:

$$ \tan\delta = \frac{34}{x} $$

$$ \tan\varphi = \frac{17}{36 - x} $$

Evaluating for each of these angles, we get:

$$ \delta = \tan^{-1}\left(\frac{34}{x}\right) $$

$$ \varphi = \tan^{-1}\left(\frac{17}{36 - x}\right) $$
...
$$ \theta(x) = \pi - \tan^{-1}\left(\frac{34}{x}\right) - \tan^{-1}\left(\frac{17}{36 - x}\right) $$

Now find the first derivative:

$$ \theta'(x) = -\frac{1}{1 + \left(\dfrac{34}{x}\right)^2}\left(\frac{34}{x}\right)' - \frac{1}{1 + \left(\dfrac{17}{36 - x}\right)^2}\left(\frac{17}{36 - x}\right)' $$

$$ \theta'(x) = -\frac{1}{1 + \left(\dfrac{34}{x}\right)^2}\left(\frac{(34)'(x) - (34)(x)'}{(x)^2}\right) - \frac{1}{1 + \left(\dfrac{17}{36 - x}\right)^2}\left(\frac{(17)'(36 - x) - (17)(36 - x)'}{(36 - x)^2}\right) $$

$$ \theta'(x) = -\frac{1}{1 + \left(\dfrac{34}{x}\right)^2}\left(\frac{-34}{x^2}\right) - \frac{1}{1 + \left(\dfrac{17}{36 - x}\right)^2}\left(\frac{-(17)(-1)}{(36 - x)^2}\right) $$

$$ \theta'(x) = -\frac{1}{1 + \left(\dfrac{34}{x}\right)^2}\left(\frac{-34}{x^2}\right) - \frac{1}{1 + \left(\dfrac{17}{36 - x}\right)^2}\left(\frac{17}{(36 - x)^2}\right) $$

$$ \theta'(x) = \frac{34}{x^2\left[1 + \left(\dfrac{34}{x}\right)^2\right]} - \frac{17}{(36 - x)^2\left[1 + \left(\dfrac{17}{36 - x}\right)^2\right]} $$

$$ \theta'(x) = \frac{34}{x^2 + 1156} - \frac{17}{(36 - x)^2 + 289} $$

$$ \theta'(x) = \frac{34}{x^2 + 1156} - \frac{17}{x^2 - 72x + 1585} $$

Setting to $0$ gets us critical point(s):

$$ \frac{34}{x^2 + 1156} - \frac{17}{x^2 - 72x + 1585} = 0 $$

$$ \frac{34}{x^2 + 1156} = \frac{17}{x^2 - 72x + 1585} $$

$$ 34\left(x^2 - 72x + 1585\right) = 17\left(x^2 + 1156\right) $$

$$ 34x^2 - 2448x + 53890 = 17x^2 + 19652 $$

$$ 17x^2 - 2448x + 34238 = 0 $$

$$ x^2 - 144x + 2014 = 0 $$

$$ x = \frac{-(-144) \pm \sqrt{(-144)^2 - 4(1)(2014)}}{2(1)} $$

$$ x = \frac{144 \pm 2\sqrt{3170}}{2} $$

$$ x = 72 \pm \sqrt{3170} $$

$$ x \approx 15.6972 \text{, } x \approx 128.3028 $$

But note that our range for $x$ is:

$$ 0 \leq x \leq 36 $$

So only the first result is a valid critical point for this problem.

We can use the First Derivative Test to determine that this will result in an
absolute maximum. As long as $\theta'(x) < 0$ for $x > 15.6972$ and
$\theta'(x) > 0$ for $x < 15.6972$ (increasing), then we know that this critical
point is an absolute maximum and will yield the largest angle for $\theta$.

$$ \theta'(x) = \frac{34}{x^2 + 1156} - \frac{17}{x^2 - 72x + 1585} $$

$$ \theta'(15) = \frac{34}{(15)^2 + 1156} - \frac{17}{(15)^2 - 72(15) + 1585} \approx 0.0013 $$

$$ \theta'(16) = \frac{34}{(16)^2 + 1156} - \frac{17}{(16)^2 - 72(16) + 1585} \approx -0.0006 $$

And indeed we have an absolute maximum at for $\theta(x)$ at
$x \approx 15.6972 \text{ in}$, and this is where we should place the stake to
get the maximum angle formed by the two pieces of wire.
...
$$ \theta = \text{ the angle formed by the folds that make the trough} $$

$$ b = \text{ the base of one of the resulting triangles on one of the sides} $$

$$ h = \text{ the height of one of the resulting triangles on one of the sides, also the height of the middle rectangle formed} $$

$$ A_{\text{rect}} = 30h = \text{ the area of the rectangle formed in the center of the trough} $$

$$ 2A_{\text{tri}} = 2\left(\frac{1}{2}bh\right) = \text{ the total area of the two triangles formed on both sides of the trough} $$

$$ A = A_{\text{rect}} + 2A_{\text{tri}} = \text{ the total area of the trough} $$

Note that we are establishing $b$ and $h$ as being formed by a triangle that is
traversed via a cross-sectional diagram. We also establish $\theta$ as the angle
formed by this cross section. See **Example 8** from the notes to see more
details as to why we can do this.

We can therefore establish based off of the standard right angle trigonometry
that $b$ and $h$ can be expressed in terms of $\theta$ like so:
...
We now can establish the total Area in terms of $\theta$:

$$ A = A_{\text{rect}} + 2A_{\text{tri}} $$

$$ A = 30h + 2\left(\frac{1}{2}bh\right) $$

$$ A(\theta) = 30(30\sin\theta) + 2\left(\frac{1}{2}(30\cos\theta)(30\sin\theta)\right) $$

$$ A(\theta) = 900\sin\theta + 900\sin\theta\cos\theta $$

$$ A(\theta) = 900(\sin\theta + \sin\theta\cos\theta) $$

We're trying to maximize this area, so we'll need the first derivative:

$$ A'(\theta) = 900\left[\cos\theta + (\sin\theta)'(\cos\theta) + (\sin\theta)(\cos\theta)'\right] $$

$$ A'(\theta) = 900\left[\cos\theta + (\cos\theta)(\cos\theta) + (\sin\theta)(-\sin\theta)\right] $$

$$ A'(\theta) = 900\left[\cos\theta + \cos^2\theta - \sin^2\theta \right] $$

$$ A'(\theta) = 900\left[\cos\theta + \cos^2\theta - (1 - \cos^2\theta) \right] $$

$$ A'(\theta) = 900\left[\cos\theta + \cos^2\theta - 1 + \cos^2\theta \right] $$

$$ A'(\theta) = 900\left(2\cos^2\theta + \cos\theta - 1\right) $$

$$ A'(\theta) = 900(2\cos\theta - 1)(\cos\theta + 1) $$

Setting this to $0$, we get some critical point(s) for $\theta$:
...
But we know that because of how right angle triangles work, that $\theta$ has a
range:

$$ 0 \leq \theta \leq \frac{\pi}{2} $$

And so only the first critical point works here.

We can now take this critical point of $\theta = \dfrac{\pi}{3}$ and plug it
into our area function $A(\theta)$, take the maximum and that will be our
solution.

$$ A(\theta) = 900(\sin\theta + \sin\theta\cos\theta) $$

$$ A(0) = 900(\sin(0) + \sin(0)\cos(0)) = 0 $$

$$ A\left(\frac{\pi}{3}\right) = 900(\sin\left(\frac{\pi}{3}\right) + \sin\left(\frac{\pi}{3}\right)\cos\left(\frac{\pi}{3}\right)) \approx 1169.1343 $$

$$ A\left(\frac{\pi}{2}\right) = 900(\sin\left(\frac{\pi}{2}\right) + \sin\left(\frac{\pi}{2}\right)\cos\left(\frac{\pi}{2}\right)) = 900 $$
...
This is similar to 22, so we'll move a bit faster, but with a caveat, the base
of the rectangle in the center is $4 \text{ m}$, which is unlike problem 22
where the hypotenuses of the formed triangles were the same length as this base
of the rectangle, so we'll have to calculate things a little differently.

The variables $b$ and $h$ will remain the same, with the length of the
hypotenuse on each side being $1 \text{ m}$. $\theta$ similarly represents the
same idea of the angle. Thusly we can find $b$ and $h$ firstly in almost the
same manner:
...
Again, the hypotenuse is $1$ so that makes it easy.

Now let's establish the total Area in terms of $\theta$:

$$ A = A_{\text{rect}} + 2A_{\text{tri}} $$

$$ A = 4h + 2\left(\frac{1}{2}bh\right) $$

$$ A(\theta) = 4\sin\theta + 2\left(\frac{1}{2}(\cos\theta)(\sin\theta)\right) $$

$$ A(\theta) = 4\sin\theta + \sin\theta\cos\theta $$

Unlike in 22, this is more or less as far as we can simplify, factoring out
$\sin\theta$ could potentially trip us up here, so let's leave it and find our
first derivative:

$$ A'(\theta) = (4)'(\sin\theta) + (4)(\sin\theta)' + (\sin\theta)'(\cos\theta) + (\sin\theta)(\cos\theta)' $$

$$ A'(\theta) = 4\cos\theta + (\cos\theta)(\cos\theta) + (\sin\theta)(-\sin\theta) $$

$$ A'(\theta) = 4\cos\theta + \cos^2\theta - \sin^2\theta $$

$$ A'(\theta) = 4\cos\theta + \cos^2\theta - \left(1 - \cos^2\theta\right) $$

$$ A'(\theta) = 4\cos\theta + \cos^2\theta - 1 + \cos^2\theta $$

$$ A'(\theta) = 2\cos^2\theta + 4\cos\theta - 1 $$

Unlike in 22, we cannot factor this out easily, let's use the quadratic formula:

$$ \cos\theta = \frac{-(4) \pm \sqrt{(4)^2 - 4(2)(-1)}}{2(2)} $$

$$ \cos\theta = \frac{-4 \pm 2\sqrt{6}}{4} $$

$$ \cos\theta = -1 \pm \frac{\sqrt{6}}{2} $$

$$ \cos\theta \approx -2.2247 \text{, } \cos\theta \approx 0.2247 $$

We only take the positive as $-2.2247$ lies outside the standard range for
cosine which is $[-1, 1]$.

$$ \theta = \cos^{-1}\left(-1 + \frac{\sqrt{6}}{2}\right) \approx 1.3441 $$

Again, $\theta$ lies in the range of:

$$ 0 \leq \theta \leq \frac{\pi}{2} $$

So our approximation of $1.3441$ radians works out for $\theta$. Let's evaluate
these endpoints and our critical point to determine which yields maximum volume.

$$ A(\theta) = 4\sin\theta + \sin\theta\cos\theta $$

$$ A(0) = 4\sin(0) + \sin(0)\cos(0) = 0 $$

$$ A(1.3441) \approx 4\sin(1.3441) + \sin(1.3441)\cos(1.3441) \approx 4.1167 $$

$$ A\left(\frac{\pi}{2}\right) = 4\sin\left(\frac{\pi}{2}\right) + \sin\left(\frac{\pi}{2}\right)\cos\left(\frac{\pi}{2}\right) = 4 $$

So, we will get a maximum cross-sectional area, and hence a maximum volume, when
$\theta \approx 1.3441$ radians.
