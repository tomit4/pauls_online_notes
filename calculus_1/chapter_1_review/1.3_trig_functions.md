...
$$ \boxed{\sec\left(\dfrac{29\pi}{4}\right) = -\sqrt{2}} $$
...
$$ \cot\left(\dfrac{5\pi}{4}\right) = \frac{-\dfrac{\sqrt{2}}{2}}{-\dfrac{\sqrt{2}}{2}} = 1 $$
...
$$ \boxed{\tan\left(\dfrac{31\pi}{6}\right) = \frac{\sqrt{3}}{3}} $$
